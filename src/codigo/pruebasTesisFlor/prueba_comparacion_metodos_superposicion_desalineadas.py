...
"""
Tenemos dos turbinas parcialmente desalineadas (1.75D en y) separadas por 8D en z
...
turbina_1 = Turbina_Paper(Coord(np.array([8*D,1.75*D,0.125])))
...
plt.savefig('superposicion_desalineadas.pdf')
plt.show()

...
# que valor de U_inf uso gonza?? estoy usando U_inf = 7.5
...
deficit_normalizado_25 = deficit_normalizado_25[228:271]
coordenada_y = coordenada_y[228:271]
...
# recorto donde tiene sentido que la modele como una gaussiana
deficit_normalizado_5 = deficit_normalizado_5[228:271]
coordenada_y = coordenada_y[228:271]
...
# recorto donde tiene sentido que la modele como una gaussiana
deficit_normalizado_10 = deficit_normalizado_10[228:271]
coordenada_y = coordenada_y[228:271]
...
# recorto donde tiene sentido que la modele como una gaussiana
deficit_normalizado_20 = deficit_normalizado_20[228:271]
coordenada_y = coordenada_y[228:271]
...
coordenadas = np.array([2.5, 5, 10])
sigmas = np.array([sigma_25, sigma_5, sigma_10])

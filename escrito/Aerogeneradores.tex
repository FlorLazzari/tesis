...
% habria que escribir que el pronostico de potencia permite calcular los loads sobre las turbinas
...
% problema de machine learning es que la toma de mediciones es muy mala (el banco de datos es dificil de generarlo)

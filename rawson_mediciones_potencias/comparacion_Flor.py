...
Pu=f1(Um)
plt.plot([0,42],[Pu,Pu],'k-',linewidth=1,label='Power(U_met)') 
plt.xlim(-1,43)
plt.ylim(0,Pu*1.5)
plt.title('Dir: '+str(Dir)+',Umet: '+str(Um))
plt.legend(loc='lower right',fontsize = 'small') 
plt.grid()
plt.savefig('rawsonPotenciaComparacion_'+str(Dir), dpi = 300)     
plt.show
plt.clf
################################################################################ 
#----VALORES EN MAPA
...
plt.ylabel('y (m)')  
plt.grid()
plt.savefig('rawsonPotenciaMedidas_'+str(Dir), dpi = 300)     
plt.show
plt.clf